...
If the chosen approach involves user-facing UI, generate a rough wireframe:

1. Check DESIGN.md for design system constraints
2. Generate self-contained HTML with:
   - System fonts, thin gray borders, minimal styling
   - Core interaction flow (1-3 screens)
   - Realistic placeholder content
   - Inline CSS (no external dependencies)

Write to: `SKETCH_FILE="/tmp/gstack-sketch-$(date +%s).html"`

If browse available: `$B goto "file://$SKETCH_FILE"`
Otherwise: Provide file path for manual opening

Show screenshot and ask: "Does this feel right? Want to iterate?"
