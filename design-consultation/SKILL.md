...
**Note:** This skill generates an HTML preview page to visualize the proposed design system. No additional setup required.
...
Use the Phase 3 proposal as the primary source for DESIGN.md values — colors, typography, and spacing grounded in the design proposal text descriptions. The HTML preview page gave the user a visual sense of the design system; now translate those decisions into the structured DESIGN.md format.
